    ...
    <main class="max-w-xl mt-6 mx-auto">
        <article class="flex flex-col items-center gap-12">
            ...
            <section class="w-full flex flex-col items-center gap-4">
                <img src="{{ asset('storage/' . $company->logo) }}" alt="" class="rounded-xl w-48">
            ...
            {{-- If in the future I want to add testimonials for companies, this component is already dynamic and ready to accept a model called $company --}}
