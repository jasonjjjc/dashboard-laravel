...
<x-layout>
    ...
    @auth
        <div class="w-full flex flex-col items-center lg:flex-row lg:items-start lg:gap-8">
            ...
            <main class="flex flex-col w-full md:items-center  border-b border-gray-100 pb-8">
                <div class="flex items-center justify-between w-full max-w-2xl">
                    ...
                    @auth
                        <a href="admin/employees/create" class="py-1 px-3 bg-blue-500 h-fit w-fit rounded-md text-sm text-white">Add</a>
                    @endauth
                </div>
    ...
    @else
        <main class="flex flex-1 flex-col items-center justify-center max-w-6xl">
            <div class="space-y-6">
                ...
                <div>
                    <p class="text-center ">Please <a href="/register" class="font-bold text-blue-500">register</a> or <a href="/login"
