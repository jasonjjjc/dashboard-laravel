<main class="w-full max-w-sm md:max-w-xl mt-6 mx-auto flex flex-col md:flex-row">
    ...
    <article class="flex-1 flex flex-col items-start gap-6 rounded-sm md:pr-8">
        <a href="/admin/{{ isset($employee) ? 'employees' : 'companies' }}"
            class="text-blue-500 font-semibold py-2 text-sm hover:text-blue-600">Back to all
    ...
    <form method="POST"
        ...
        @if (isset($employee))
            <div class="relative flex flex-col">
                ...
                <select name="company_id" class="border border-blue-500 rounded-md px-4 py-2 focus:outline-blue-500">
